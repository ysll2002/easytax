...
export const metadata: Metadata = {
  ...
  description: 'EasyTax is MTD-ready MTD ITSA software for UK sole traders, self-employed and landlords. File quarterly updates, Self Assessment, VAT and CT600 directly to HMRC for £20 + VAT per submission. No monthly subscription.',
  alternates: { canonical: 'https://easytax.vip/mtd-software' },
  openGraph: {
    title: 'MTD ITSA Software — EasyTax, £24 per Filing, No Subscription',
    description: 'MTD-ready Making Tax Digital software for sole traders and landlords. Quarterly updates, Self Assessment, VAT, CT600 — £24 per filing, no monthly fee.',
  ...
  twitter: {
    ...
    description: 'MTD-ready Making Tax Digital software. No subscription — pay only when you file.',
  },
};
...
export default async function MtdSoftware() {
  ...
  const jsonLd = {
    ...
    operatingSystem: 'Web',
    description: 'MTD-ready MTD ITSA software for UK sole traders, self-employed and landlords. File Making Tax Digital quarterly updates, Self Assessment, VAT and CT600 directly to HMRC.',
        ...
        <section className="pt-12 sm:pt-16 pb-10 sm:pb-14">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium mb-5" style={{ backgroundColor: '#F0EBE1', color: '#C4622D', border: '1px solid #C4622D30' }}>
              <Sparkles size={12} /> MTD-ready MTD ITSA software
            </div>
