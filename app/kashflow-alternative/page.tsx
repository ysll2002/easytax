...
export const metadata: Metadata = {
  title: 'KashFlow Alternative — MTD ITSA Software for UK Freelancers, £24 per Filing',
  description: 'Looking for a KashFlow alternative? EasyTax files MTD ITSA quarterly updates, Self Assessment, VAT and CT600 directly to HMRC for £20 + VAT (£24 inc. VAT) per submission — no monthly subscription, no card to sign up.',
  alternates: { canonical: 'https://easytax.vip/kashflow-alternative' },
  openGraph: {
    title: 'KashFlow Alternative — MTD ITSA + Self Assessment + VAT',
    description: 'KashFlow charges £10–27+VAT/month on subscription. EasyTax files MTD ITSA, Self Assessment, VAT and CT600 for £24 per submission — no subscription.',
    url: 'https://easytax.vip/kashflow-alternative',
    type: 'article',
    locale: 'en_GB',
    siteName: 'EasyTax',
  },
  twitter: {
    ...
    title: 'KashFlow Alternative — MTD ITSA Software, £24 per Filing',
    description: 'KashFlow charges £120–324+VAT/year. EasyTax charges £24 per submission, no subscription.',
  },
};

const display = 'var(--font-display), Playfair Display, Georgia, serif';

type Row = { feature: string; easytax: string | boolean; kashflow: string | boolean; note?: string };

const rows: Row[] = [
  { feature: 'Pricing model',                         easytax: '£24 per filing',  kashflow: 'From £10+VAT/mo',    note: 'KashFlow charges a monthly subscription; EasyTax charges £20+VAT per HMRC submission' },
  { feature: 'Typical annual cost',                   easytax: '~£120',            kashflow: '£120–324+VAT',        note: 'Based on 4 quarterly updates + 1 final declaration for EasyTax; KashFlow Starter–Business plans' },
  { feature: 'No card to sign up',                    easytax: true,              kashflow: false },
  { feature: 'MTD ITSA quarterly updates',            easytax: true,              kashflow: true },
  { feature: 'Self Assessment (SA100, SA103, SA105)', easytax: true,              kashflow: true },
  { feature: 'MTD VAT submission',                    easytax: true,              kashflow: true },
  { feature: 'CT600 Corporation Tax filing',          easytax: true,              kashflow: true },
  { feature: 'Limited company P&L and Balance Sheet', easytax: true,              kashflow: true },
  { feature: 'Open Banking auto-import',              easytax: true,              kashflow: true },
  { feature: 'AI expense categorisation',             easytax: true,              kashflow: false,                 note: 'EasyTax uses Claude to categorise and reconcile' },
  { feature: 'AI bank reconciliation chat',           easytax: true,              kashflow: false },
  { feature: 'Full double-entry bookkeeping',         easytax: false,             kashflow: true,                  note: 'EasyTax focuses on tax filing, not a full ledger' },
  { feature: 'Built-in invoicing',                    easytax: false,             kashflow: true,                  note: 'EasyTax pairs with GrumpyWhales (free) for invoicing' },
  { feature: 'Purchase order management',             easytax: false,             kashflow: true },
  { feature: 'Payroll',                               easytax: false,             kashflow: true,                  note: 'Available in KashFlow PLUS and higher tiers' },
];
...
export default async function KashFlowAlternative() {
  ...
  const jsonLd = {
    ...
    '@type': 'Article',
    headline: 'KashFlow Alternative — MTD ITSA Software for UK Freelancers',
    description: 'Side-by-side comparison of EasyTax and KashFlow for UK sole traders, landlords and limited companies. EasyTax files MTD ITSA, Self Assessment, VAT and CT600 for £24 per submission with no subscription.',
    author: { '@type': 'Organization', name: 'EasyTax' },
    publisher: { '@type': 'Organization', name: 'Finance Panda Limited' },
    mainEntityOfPage: 'https://easytax.vip/kashflow-alternative',
  };
      ...
      <main className="flex-grow">
        ...
        <section className="pt-12 sm:pt-16 pb-10 sm:pb-14">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium mb-5" style={{ backgroundColor: '#F0EBE1', color: '#C4622D', border: '1px solid #C4622D30' }}>
              <Sparkles size={12} /> The no-subscription KashFlow alternative
            </div>
            <h1 style={{ fontFamily: display, fontSize: 'clamp(2rem, 5vw, 3.25rem)', fontWeight: 700, lineHeight: 1.15, letterSpacing: '-0.02em', marginBottom: '1.25rem' }}>
              Paying <em style={{ color: '#C4622D', fontStyle: 'italic' }}>£120–324/year</em> for KashFlow? EasyTax files the same returns for £24 each.
            </h1>
            <p className="text-base sm:text-xl leading-relaxed mb-6" style={{ color: '#4A4035', maxWidth: '680px' }}>
              KashFlow is solid bookkeeping software — but if you are a UK freelancer or sole trader who mainly needs to file <strong style={{ color: '#1C1208' }}>MTD ITSA quarterly updates</strong> and <strong style={{ color: '#1C1208' }}>Self Assessment</strong>, you are paying a monthly subscription for features you will never use. EasyTax covers all the same HMRC filings for <strong style={{ color: '#6B8E6E' }}>£20 + VAT (£24 inc. VAT) per submission</strong> — no monthly fee, no card required to start.
            </p>
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <a href="mailto:hello@easytax.vip?subject=KashFlow%20migration" className="inline-block px-6 py-3 rounded-full font-medium text-sm" style={{ backgroundColor: '#FDFCF8', color: '#1C1208', border: '1.5px solid #DDD5C8' }}>
                Ask us a question
              </a>
            </div>
          </div>
        ...
        <section className="py-12 sm:py-14" style={{ backgroundColor: '#F0EBE1' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <h2 style={{ fontFamily: display, fontSize: 'clamp(1.5rem, 3.5vw, 2rem)', fontWeight: 700, marginBottom: '1.25rem' }}>
              MTD ITSA is now mandatory — do you really need to pay £120–324/year for it?
            </h2>
            <p className="text-base leading-relaxed mb-6" style={{ color: '#4A4035', maxWidth: '680px' }}>
              From <strong>6 April 2026</strong>, every UK sole trader or landlord with income above <strong>£50,000</strong> must file quarterly updates through MTD-compatible software. The threshold drops to <strong>£30,000</strong> in April 2027. If your main reason for using KashFlow is to stay HMRC-compliant, EasyTax gives you the same compliance at a fraction of the cost.
            </p>
        ...
        <section className="py-16 sm:py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <h2 style={{ fontFamily: display, fontSize: 'clamp(1.75rem, 4vw, 2.5rem)', fontWeight: 700, marginBottom: '1.5rem' }}>
              Side-by-side: <em style={{ color: '#C4622D', fontStyle: 'italic' }}>KashFlow</em> vs EasyTax
            </h2>
            <div className="rounded-2xl overflow-hidden" style={{ border: '1px solid #E8E2DA', backgroundColor: '#FFFFFF' }}>
              <div className="grid grid-cols-[1.6fr_1fr_1fr]">
                ...
                <div className="px-4 py-4 text-center" style={{ backgroundColor: '#F8F5F0', borderBottom: '1px solid #E8E2DA' }}>
                  <p className="text-xs font-semibold uppercase tracking-wider mb-0.5" style={{ color: '#9A8F83' }}>KashFlow</p>
                  <p className="text-sm font-bold" style={{ color: '#1C1208' }}>£10–27+VAT/mo</p>
                </div>
            ...
            <p className="text-xs mt-3" style={{ color: '#9A8F83' }}>
              KashFlow pricing reflects published plans as of mid-2026. We are not affiliated with KashFlow or IRIS Software Group. KashFlow is a registered trademark of KashFlow Ltd (an IRIS company).
            </p>
          </div>
        </section>
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              <div className="p-6 rounded-2xl" style={{ backgroundColor: '#E2EDE2', border: '1px solid #6B8E6E30' }}>
                ...
                <ul className="space-y-2 text-sm" style={{ color: '#1C1208' }}>
                  <li className="flex gap-2"><Check size={16} color="#6B8E6E" className="flex-shrink-0 mt-0.5" /><span>No subscription — pay only when you actually file with HMRC.</span></li>
                  ...
                  <li className="flex gap-2"><Check size={16} color="#6B8E6E" className="flex-shrink-0 mt-0.5" /><span>Built from the ground up for MTD ITSA — not a legacy product retrofitted for MTD compliance.</span></li>
                  <li className="flex gap-2"><Check size={16} color="#6B8E6E" className="flex-shrink-0 mt-0.5" /><span>Simpler interface for sole traders who want to file quickly without learning bookkeeping.</span></li>
                </ul>
              </div>
              <div className="p-6 rounded-2xl" style={{ backgroundColor: '#F5E4D8', border: '1px solid #C4622D30' }}>
                <p className="text-xs font-semibold uppercase tracking-wider mb-3" style={{ color: '#C4622D' }}>Where KashFlow wins</p>
                <ul className="space-y-2 text-sm" style={{ color: '#1C1208' }}>
                  <li className="flex gap-2"><ArrowRight size={16} color="#C4622D" className="flex-shrink-0 mt-0.5" /><span>Full double-entry bookkeeping and purchase ledger (EasyTax handles P&L and Balance Sheet for Ltd companies, not a full accounting ledger).</span></li>
                  <li className="flex gap-2"><ArrowRight size={16} color="#C4622D" className="flex-shrink-0 mt-0.5" /><span>Native invoicing with customer records and payment tracking.</span></li>
                  <li className="flex gap-2"><ArrowRight size={16} color="#C4622D" className="flex-shrink-0 mt-0.5" /><span>Purchase order management for product-based businesses.</span></li>
                  <li className="flex gap-2"><ArrowRight size={16} color="#C4622D" className="flex-shrink-0 mt-0.5" /><span>Built-in payroll available on higher plans.</span></li>
                  <li className="flex gap-2"><ArrowRight size={16} color="#C4622D" className="flex-shrink-0 mt-0.5" /><span>More established ecosystem with accountant integrations.</span></li>
                </ul>
              </div>
            </div>
            <p className="mt-5 text-sm leading-relaxed" style={{ color: '#4A4035', maxWidth: '680px' }}>
              If you run a product business, have employees, or need purchase orders and invoicing in the same tool — KashFlow may be worth the subscription. But if you are a <strong>freelancer or landlord who mainly wants to stay HMRC-compliant without a monthly bill</strong>, EasyTax is the better fit.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20" style={{ backgroundColor: '#F0EBE1' }}>
          <div className="max-w-3xl mx-auto px-4 sm:px-6">
            <h2 style={{ fontFamily: display, fontSize: 'clamp(1.75rem, 4vw, 2.5rem)', fontWeight: 700, marginBottom: '1.5rem' }}>
              How to switch from KashFlow
            </h2>
            <ol className="space-y-5">
              {[
                {
                  title: 'Export your KashFlow data',
                  body: 'In KashFlow: Reports → Export. Download your transactions and records as CSV for your files before cancelling.',
                },
                {
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6">
            ...
            <div style={{ borderTop: '1px solid #DDD5C8' }}>
              {[
                ...
                {
                  q: 'I use KashFlow for invoicing. What do I do?',
                  a: "EasyTax doesn't have a built-in invoicing module. We pair with GrumpyWhales — a free UK invoicing tool — for that. Many sole traders run two lightweight free tools rather than one monthly-subscription bundle.",
                },
                {
                ...
                {
                  q: 'Is KashFlow being discontinued?',
                  a: 'KashFlow is actively maintained by IRIS Software Group and is not being discontinued. That said, IRIS has been consolidating products across its portfolio — if you want software that is 100% focused on MTD filing for UK freelancers, EasyTax is built for exactly that use case.',
                },
                {
        ...
        <section className="py-20 sm:py-24" style={{ backgroundColor: '#1C1208' }}>
          <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
            <h2 style={{ fontFamily: display, fontSize: 'clamp(1.75rem, 4vw, 2.75rem)', fontWeight: 700, color: '#FDFCF8', lineHeight: 1.15, marginBottom: '1.25rem' }}>
              Stop paying a monthly fee just to stay HMRC-compliant.<br />
            ...
            <div className="flex items-center justify-center gap-3 flex-wrap">
              ...
              <a href="mailto:hello@easytax.vip?subject=KashFlow%20migration" className="inline-block px-10 py-4 rounded-full font-medium" style={{ backgroundColor: '#FDFCF8', color: '#1C1208' }}>
                Ask us a question
              </a>
            </div>
          </div>
