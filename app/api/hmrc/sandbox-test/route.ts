...
export async function GET() {
  ...
  try {
    ...
    await call(results, 'Dividends Income', `/individuals/dividends-income/${nino}/${taxYear}`, 'PUT', token, fph, { accept: 'application/vnd.hmrc.2.0+json', body: { dividends: { ukDividends: 300.00 } } });
