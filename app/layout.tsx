...
export const metadata: Metadata = {
  ...
  description: 'Free MTD ITSA software for UK sole traders, landlords and limited companies. Send quarterly updates to HMRC, file Self Assessment, VAT returns and CT600. £0/year — no card needed.',
  keywords: [
    'MTD ITSA software',
  ...
  openGraph: {
    ...
    description: 'MTD ITSA is live. Send quarterly updates to HMRC, file Self Assessment, VAT and CT600 — £0/year.',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'EasyTax — Free MTD ITSA software' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'EasyTax — Free MTD ITSA Software for UK Sole Traders & Limited Companies',
    description: 'MTD ITSA is live. Quarterly HMRC updates, Self Assessment, VAT and CT600 — £0/year.',
    images: ['/og-image.png'],
  },
