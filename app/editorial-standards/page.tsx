    ...
    <div className="flex flex-col min-h-screen" style={{ backgroundColor: '#FDFCF8', color: INK }}>
      ...
      <footer style={{ borderTop: '1px solid #2E2418', backgroundColor: '#1C1208', padding: '2rem 0' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <div style={{ fontFamily: 'var(--font-display), Playfair Display, Georgia, serif', fontSize: '1rem', color: BODY }}>
            Finance Panda Limited. Built in London.
          </div>
          <div className="flex gap-6 text-sm" style={{ color: BODY }}>
            <Link href="/trust" className="hover:text-[#C4622D] transition-colors">Trust</Link>
